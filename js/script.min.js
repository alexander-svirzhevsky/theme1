...
"use strict";$(function(){var a=$(".tabs-card__list"),i=$(".tabs-card__text");a.on("click",function(a){var t=a.target,s=a.target.dataset.tab;if(a.preventDefault(),$(t).closest(".tabs-card__item")){$(".tabs-card__item").removeClass("tabs-card__item-active"),$(t).closest(".tabs-card__item").addClass("tabs-card__item-active");for(var e=0;e<i.length;e++){var r=i[e],c=$(r).hasClass(s);c&&$(r).removeClass("tabs-hiden"),c||$(r).addClass("tabs-hiden")}}})});